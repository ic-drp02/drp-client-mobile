...
export default {
  ...
  // Color
  brandPrimary: "#2f80ed", // CHANGED FROM platform === PLATFORM.IOS ? '#007aff' : '#3F51B5',
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: "#2f80ed", // CHANGED FROM platform === PLATFORM.IOS ? '#F8F8F8' : '#3F51B5',
  ...
  // Header
  toolbarBtnColor: "#fff", // CHANGED FROM platform === PLATFORM.IOS ? "#007aff" : "#fff",
  toolbarDefaultBg: "#2f80ed", // CHANGED FROM platform === PLATFORM.IOS ? '#F8F8F8' : '#3F51B5',
  ...
  titleFontColor: "#fff", // CHANGED FROM platform === PLATFORM.IOS ? "#000" : "#fff",
